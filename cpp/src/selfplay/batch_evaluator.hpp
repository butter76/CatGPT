...
private:
    ...
    void setup_io() {
        ...
        for (int i = 0; i < num_io; ++i) {
            ...
            // ONNX exports a single policy head named `optimistic_policy_logit`;
            // either substring is accepted to keep this robust to future
            // renamings.
     ...
     *   - D2H: wdl_logits, value_probs, policy
     *
