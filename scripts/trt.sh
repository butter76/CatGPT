...
#
# Bucket sizes: 1, 2, 3, 4, 8, 16, 32, 56, 112
...
/home/shadeform/TensorRT-10.13.3.9/bin/trtexec \
  ...
  --profile=4 --minShapes=in_0:8x64   --optShapes=in_0:8x64   --maxShapes=in_0:8x64 \
  --profile=5 --minShapes=in_0:16x64  --optShapes=in_0:16x64  --maxShapes=in_0:16x64 \
  --profile=6 --minShapes=in_0:32x64  --optShapes=in_0:32x64  --maxShapes=in_0:32x64 \
  --profile=7 --minShapes=in_0:56x64  --optShapes=in_0:56x64  --maxShapes=in_0:56x64 \
  --profile=8 --minShapes=in_0:112x64 --optShapes=in_0:112x64 --maxShapes=in_0:112x64
